...
ALTER TABLE config_visual ADD COLUMN IF NOT EXISTS "faqInfo" JSONB DEFAULT '{"titulo":"Preguntas Frecuentes","descripcion":"","items":[]}'::jsonb;
ALTER TABLE config_visual ADD COLUMN IF NOT EXISTS "organigramaInfo" JSONB DEFAULT '{"titulo":"Organigrama","imageUrl":"","descripcion":"Estructura organizacional de la División Federal."}'::jsonb;
